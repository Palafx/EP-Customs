...
function s.cost(e,tp,eg,ep,ev,re,r,rp,chk)
  ...
  local gn=Duel.GetOperatedGroup()
	e:SetLabel(gn:FilterCount(Card.IsLocation,nil,LOCATION_DECK)*100)
end
