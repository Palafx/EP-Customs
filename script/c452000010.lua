...
function s.initial_effect(c)
  --Link Summon
  Link.AddProcedure(c,aux.FilterBoolFunctionEx(Card.IsSetCard,0x53d),1,1)
  c:EnableReviveLimit()
...
function s.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
  ...
  Duel.SetOperationInfo(0,CATEGORY_SPECIAL_SUMMON,g,#g,0,LOCATION_HAND+LOCATION_GRAVE)
end
