--Loki, Generaider Boss of Illusions
...
--mill
function s.filter(c)
	return c:IsMonster() and c:IsSetCard(SET_GENERAIDER) or c:IsRace(RACE_SPELLCASTER) and not c:IsCode(id) and c:IsAbleToGrave()
end
